                ...
                <v-card class="pa-6 pub" outlined  @click="handleClick(n.id)">
                  <v-row>
                    ...
                    <v-col cols="12" sm="8">
                        ...
                        <span > <b>Dificuldade: </b>{{ n.dificuldade }} </span>
                    </v-col>
                  </v-row>
                  <v-row>
...
export default {
    ...
    created() {                 
        ...
        this.recs = [
            ...
            {id:"rec_7",titulo:"Bolo de aveia", dificuldade: "Fácil", creator:"ricardo", gostos: [] , data:"2021-02-02 13:23:23", descricao:"1. Numa taça, junte o açúcar mascavado escuro e a manteiga sem sal à temperatura ambiente e bata. Junte os ovos e incorpore com a batedeira.\n2. Junte a farinha e o fermento, com uma peneira, e incorpore.\n3. Corte a banana em pedacinho, junte á mistura do bolo e envolva.", ingredientes:["bacalhua","pimento","chouriça","sal","pimenta","gelado"]},
            {id:"rec_8",titulo:"Bolo de frango", dificuldade: "Difícil", creator:"henrique", gostos: ["joaquim","joao","joana"] , data:"2021-02-26 17:21:27", descricao:"1. Numa taça, junte o açúcar mascavado escuro e a manteiga sem sal à temperatura ambiente e bata. Junte os ovos e incorpore com a batedeira.\n2. Junte a farinha e o fermento, com uma peneira, e incorpore.\n3. Corte a banana em pedacinho, junte á mistura do bolo e envolva.", ingredientes:["feijoada","uma colher de sal","250g de farinha"]}
        ]          
